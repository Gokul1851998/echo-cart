...
module.exports = {
    ...
    dashboard:async (req,res)=>{
        ...
        let paymentOnline = await orderModel.find({paymentMethod:'banktransfer'})
        let paymentCod = await orderModel.find({paymentMethod:'COD'})
    ...
    let todayTtotalIncome = await orderModel.aggregate([
        ...
        res.render("admin/dashboard",{usersCount,moment,newUsers,payments,newOrders,totalIncome,liveOrders,onlineCount,codCount,monthly,canceledOrder,pending});  
    },
    ...
    editproductpage: async (req,res)=>{  
        ...
        // const type=await categoryModel.find()
            ...
            // let product=await ProdcutModel.findOne({_id: id}).populate('type','typeName').populate('brand','brand').populate('fuelType')
